 ...
 * 
 */
@WebServiceClient(name = "WaybillWsService", targetNamespace = "http://impl.ws.bos.redsun.com/", wsdlLocation = "http://127.0.0.1:8080/redsun_web/ws/waybill?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://127.0.0.1:8080/redsun_web/ws/waybill?wsdl");
